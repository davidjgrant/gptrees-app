        ...
        <div className="grid items-center gap-6">
          <div className="flex flex-col justify-center space-y-8 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[600px] text-slate-800 md:text-xl">
            ...
            <div className="mx-auto w-full max-w-full space-y-4">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <div className="flex flex-col items-center space-y-2 rounded-lg border-gray-800 p-4">
                  <div className="rounded-full bg-white bg-opacity-50 p-2">
                    <MergeIcon className="mb-2 h-6 w-6 text-black opacity-75" />
                  </div>
                ...
                <div className="flex flex-col items-center space-y-2 rounded-lg border-gray-800 p-4">
                  <div className="rounded-full bg-white bg-opacity-50 p-2">
                    <SettingsIcon className="mb-2 h-6 w-6 text-black opacity-75" />
                  </div>
                  <h2 className="text-xl font-bold text-black">
                ...
                <div className="flex flex-col items-center space-y-2 rounded-lg border-gray-800 p-4">
                  <div className="rounded-full bg-white bg-opacity-50 p-2">
                    <SearchIcon className="mb-2 h-6 w-6 text-black opacity-75" />
                  </div>
                  <h2 className="text-xl font-bold text-black">
                    Powerful Search
                  </h2>
                ...
                <div className="flex flex-col items-center space-y-2 rounded-lg border-gray-800 p-4">
                  <div className="rounded-full bg-white bg-opacity-50 p-2">
                    <LockIcon className="mb-2 h-6 w-6 text-black opacity-75" />
                  </div>
                  <h2 className="text-xl font-bold text-black">
                    Reliable Security
                  </h2>
